...
sim_null_4GM_select_sd <- function(P, N_1, N_2, Pi_11, Pi_10, Pi_01, Pi_00, beta, rho, noise, threshold, q_sampleoverlap){
  ...
  # sample_overlap
  indx_sampleoverlap <- which(rbinom(N_1, 1, q_sampleoverlap) == 1)
  X_2[indx_sampleoverlap, ] <- X_3[indx_sampleoverlap, ]
...
save.image("null-pl2-q005-seediter.RData")
