...
for (i in 1:Rp) {
  ...
  res <- sim_null_4GM_select_sd(P = 10000, N_1 = 8000, N_2 = 8000,
...
save.image("/home/jzhaoaz/sim-BWMR/individual-level/genotype012/selectionbias/cau5-noise11-pl2-ss8000.RData")
