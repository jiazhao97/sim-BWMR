##### Case-1 in summary-level simulations (qq-plot, type I error rate, power) ####
# Figures S5 in Supplementary Document
...
save.image("case-1-typeIerror-power.RData")
...
library(ggplot2)
library(reshape2)
load("case-1-typeIerror-power.RData")
