...
for (i in 1:Rp) {
  ...
  res <- sim_null_4GM_select_sd(P = 10000, N_1 = 4000, N_2 = 4000,
...
save.image("/home/jzhaoaz/sim-BWMR/individual-level/genotype012/selectionbias/cau5-noise11-pl2-ss4000.RData")
