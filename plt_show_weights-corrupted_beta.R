# Figure S12 (in the top pannel) in supplementary document
...
library(ggplot2)
library(reshape2)
load("weights-N20-C01-corbeta2.RData")
#load("weights-N20-C01-corbeta3.RData")
#load("weights-N20-C01-corbeta4.RData")
